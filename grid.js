var Graticule = (function() {
    ...
    function _bestTextColor(overlay)
    {
        ...
        if (type === 'glasto') return '#fffffe';
        if (type === 'danoffice') return '#000';
        if (type === 'farnborough') return '#fffffe';
    ...
    _.prototype.draw = function()
    {
        ...
        if (this.getMap().getZoom() < 19) return;
        //  	if (this.getMap().getZoom() < 20 && color != '#fffffe') return;
        //  	if (this.getMap().getZoom() < 17 && color == '#fffffe') return;
